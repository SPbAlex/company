...
class WorkerController extends Controller
{
    ...
    {
        AuditTable::listen(Yii::$app->user->id, $this->findModel($id)->tableName(), str_replace('action', '', __FUNCTION__));
    ...
    {
        $model = new Worker();
        AuditTable::listen(Yii::$app->user->id, $model::tableName(), str_replace('action', '', __FUNCTION__));
